...
def polygon_input():
	...
	for i in range(n):
		...
		xvertex.append(input("Enter previous x coordinate: "))
		yvertex.append(input("enter 200+previous y coordinate: "))
...
def drawpolygons(xvertex,yvertex):
	n=len(xvertex)	
	for i in range(n-1):
		lineBres(xvertex[i],yvertex[i],xvertex[i+1],yvertex[i+1])
	lineBres(xvertex[n-1],yvertex[n-1],xvertex[0],yvertex[0])	
...
def Display():
	...
	polygon_input()
	lineBres(x_min,y_min+200,x_min,y_max+200)
	lineBres(x_min,y_max+200,x_max,y_max+200)
	lineBres(x_max,y_max+200,x_max,y_min+200)
	lineBres(x_max,y_min+200,x_min,y_min+200)
	drawpolygons(xvertex,yvertex)
